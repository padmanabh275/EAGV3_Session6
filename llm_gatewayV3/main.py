...
DEFAULT_ORDER = ["ollama", "gemini", "nvidia", "groq", "cerebras", "openrouter", "openai", "github"]
...
TIER_TO_ORDER = {
    "TINY":  ["github", "openai", "openrouter", "groq", "nvidia", "cerebras", "gemini", "ollama"],
    "LARGE": ["gemini", "groq", "nvidia", "cerebras", "openai", "github", "openrouter", "ollama"],
}
